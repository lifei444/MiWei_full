...
@interface WMRegisterViewController () <UITextFieldDelegate>
...
- (WMUnderLineView *)phoneView {
    if (!_phoneView) {
        ...
        _phoneView.rightButton.titleLabel.font = [UIFont systemFontOfSize:[WMUIUtility WMCGFloatForY:15]];
...
- (UIButton *)registerButton {
    if (!_registerButton) {
        ...
        _registerButton.titleLabel.font = [UIFont fontWithName:@"Heiti SC" size:[WMUIUtility WMCGFloatForY:16]];
